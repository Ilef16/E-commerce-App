    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Prenom = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrixUnitaire = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                TotalLigne = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[Quantite] * [PrixUnitaire]", stored: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateIndex(name: "IX_Clients_Email", table: "Clients", column: "Email", unique: true);
        migrationBuilder.CreateIndex(name: "IX_Produits_Reference", table: "Produits", column: "Reference", unique: true);
        migrationBuilder.CreateIndex(name: "IX_Commandes_Numero", table: "Commandes", column: "Numero", unique: true);
        migrationBuilder.CreateIndex(name: "IX_Commandes_ClientId", table: "Commandes", column: "ClientId");
        migrationBuilder.CreateIndex(name: "IX_LignesCommande_CommandeId", table: "LignesCommande", column: "CommandeId");
        migrationBuilder.CreateIndex(name: "IX_LignesCommande_ProduitId", table: "LignesCommande", column: "ProduitId");
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropTable(name: "LignesCommande");
